			...
			<form action="./UpdateProductSrv" method="post"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Laptop Model</label> <input type="text"
							placeholder="Enter Laptop Model" name="name" class="form-control"
					...
					<div class="col-md-6 form-group">
						...
						%>
						<label for="producttype">Brand</label> <select name="type"
							id="producttype" class="form-control" required>
							<option value="asus"
								<%="asus".equalsIgnoreCase(ptype) ? "selected" : ""%>>Asus</option>
							<option value="hp"
								<%="hp".equalsIgnoreCase(ptype) ? "selected" : ""%>>HP</option>
							<option value="lenovo"
								<%="lenovo".equalsIgnoreCase(ptype) ? "selected" : ""%>>Lenovo</option>
							<option value="dell"
								<%="dell".equalsIgnoreCase(ptype) ? "selected" : ""%>>Dell</option>
							<option value="acer"
								<%="acer".equalsIgnoreCase(ptype) ? "selected" : ""%>>Acer</option>
							<option value="others"
