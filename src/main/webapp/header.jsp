...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		...
		<h2>msKtm lapTops</h2>
		<h6>One Place for All Laptops</h6>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#">Brand <span class="caret"></span>
					</a>
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=asus">Asus</a></li>
							<li><a href="index.jsp?type=hp">HP</a></li>
							<li><a href="index.jsp?type=lenovo">Lenovo</a></li>
							<li><a href="index.jsp?type=dell">Dell</a></li>
							<li><a href="index.jsp?type=acer">Acer</a></li>
							<li><a href="index.jsp?type=others">Others</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=asus">Asus</a></li>
							<li><a href="userHome.jsp?type=hp">HP</a></li>
							<li><a href="userHome.jsp?type=lenovo">Lenovo</a></li>
							<li><a href="userHome.jsp?type=dell">Dell</a></li>
							<li><a href="userHome.jsp?type=acer">Acer</a></li>
							<li><a href="userHome.jsp?type=others">Others</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=asus">Asus</a></li>
							<li><a href="adminViewProduct.jsp?type=hp">HP</a></li>
							<li><a href="adminViewProduct.jsp?type=lenovo">Lenovo</a></li>
							<li><a href="adminViewProduct.jsp?type=dell">Dell</a></li>
							<li><a href="adminViewProduct.jsp?type=acer">Acer</a></li>
							<li><a href="adminViewProduct.jsp?type=others">Others</a></li>
						</ul></li>
