...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductBean> getAllProducts() {
		...
		try {
			ps = con.prepareStatement("select * from product order by RAND()");
	...
	public List<ProductBean> getAllProductsByType(String type) {
		...
		try {
			ps = con.prepareStatement("SELECT * FROM product where lower(ptype) like ? order by RAND();");
			ps.setString(1, "%" + type + "%");
			rs = ps.executeQuery();
	...
	public List<ProductBean> searchAllProducts(String search) {
		...
		try {
			ps = con.prepareStatement(
					"SELECT * FROM product where lower(ptype) like ? or lower(pname) like ? or lower(pinfo) like ? order by RAND()");
			search = "%" + search + "%";
	...
	public ProductBean getProductDetails(String prodId) {
		...
		try {
			ps = con.prepareStatement("select * from product where pid=? order by RAND()");
